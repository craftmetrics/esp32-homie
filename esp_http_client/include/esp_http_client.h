...
typedef struct {
    ...
    int                         port;                /*!< Port to connect, default depend on esp_http_client_h_transport_t (80 or 443) */
    ...
    esp_http_client_h_transport_t h_transport_type;           /*!< HTTP transport type, see `esp_http_client_h_transport_t` */
